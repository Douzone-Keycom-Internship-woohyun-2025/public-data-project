...
| ADDDATE | VARCHAR(17) | NOT NULL | 계정 생성일시 (YYYYMMDDHHmmssfff) |
...
| USER_TBLKEY | INT | FK → USERS.USER_TBLKEY, NOT NULL | 사용자 식별자 |
...
| 인덱스 권장 | USER_TBLKEY, APPLICATION_NUMBER, IPC_SUBCLASS |
| 정규화 수준 | 제3정규형 (3NF) |
